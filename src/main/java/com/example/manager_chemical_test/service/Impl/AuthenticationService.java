...
import com.example.manager_chemical_test.entity.InvalidatedToken;
...
import com.example.manager_chemical_test.repository.InvalidatedTokenRepository;
    ...
    private String generateToken(UsersEntity user){
     ...
     JWSObject jwsObject = new JWSObject(header,payload);
        ...
        try {
            ...
            log.error("can not create a token", e);
